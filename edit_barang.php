...
if (isset($_POST['update'])) {
  ...
  // update user data
  $result = mysqli_query($conn, "UPDATE tbl_barang SET id_barang='$id_barang',nama='$nama' , harga = '$harga', stok = '$stok' ,  jenis = '$jenis' WHERE id_barang='$id_barang'");
...
$result = mysqli_query($conn, "SELECT * FROM tbl_barang WHERE id_barang='$id_barang'");
